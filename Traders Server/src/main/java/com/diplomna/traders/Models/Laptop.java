...
public class Laptop {
    ...
    public Laptop(String model, String brand, String screenSize, String color, String resolution, String screenTechnology, String cpu, String gpu, int ram, int refreshRate, int warranty, boolean threeDimensionalImage, boolean wifi) {
        this.model = model;
        this.brand = brand;
