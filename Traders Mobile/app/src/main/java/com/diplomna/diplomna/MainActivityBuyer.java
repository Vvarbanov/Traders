...
public class MainActivityBuyer extends ListActivity {
    ...
    void SetListViewFromStrArr(String[] str){
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getListView().getContext(), R.layout.activity_main_buyer, str);
